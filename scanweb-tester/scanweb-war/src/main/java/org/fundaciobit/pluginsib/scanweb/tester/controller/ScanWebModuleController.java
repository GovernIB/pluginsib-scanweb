...
public class ScanWebModuleController extends HttpServlet {
    ...
    /*
     * @RequestMapping(value = "/requestPlugin/{scanWebID}", method =
     * RequestMethod.GET) public void requestPluginGET(HttpServletRequest request,
     ...
     * 
     * @RequestMapping(value = "/requestPlugin/{scanWebID}", method =
     * RequestMethod.POST) public void requestPluginPOST(HttpServletRequest request,
     * HttpServletResponse response,
     * 
     * @PathVariable long scanWebID,
     * 
     * @RequestParam("restOfTheUrl") String query) throws Exception {
     * 
     * final boolean isPost = true; requestPlugin(request, response, scanWebID,
     * query, isPost);
     * 
     * }
     */
