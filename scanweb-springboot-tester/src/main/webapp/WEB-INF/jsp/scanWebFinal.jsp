...
<c:forEach items="${LAST_SCANNED_FILES}" var="scannedDocument" varStatus="theCount">
 ...
 <tr>
     ...
     * 
     * 
     * Denominaci�n normalizada del tipo de firma. Los posibles valores asignables
     ...
     * TF05 - CAdES attached/implicit signature. TF06 - PAdES. El tipo TF04 ser�
     * establecido por defecto para documentos firmados, exceptuando los documentos
     * en formato PDF o PDF/A, cuyo tipo ser� TF06. MetadataConstants.ENI_TIPO_FIRMA
     * = "eni:tipoFirma";
     * 
    --%>
     ...
     * 
     * Perfil empleado en una firma con certificado electr�nico. Los posibles
     ...
     * que pueden incluir valores como v�lida, autentica, refrenda, visa,
     ...
     * raz�n social de los firmantes.
    --%>
    <li>eniSignerName: <b>${signInfo.eniSignerName}</b></li>

    <%--
     * eEMGDE.Firma.Firmante (eEMGDE17.5.2). N�meroIdentificacionFirmantes
     --%>
     ...
     * Firma electr�nica avanzada, Claves concertadas, Firma electr�nica avanzada
     * basada en certificados, CSV, ..
     --%>
    <li>eniSignLevel: <b>${signInfo.eniSignLevel}</b></li>

    <%--
     * Informaci� de les validacions realitzades
     --%>
