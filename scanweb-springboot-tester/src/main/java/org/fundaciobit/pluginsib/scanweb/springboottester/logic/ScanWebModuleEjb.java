...
public class ScanWebModuleEjb {
    ...
    public List<Plugin> getAllPluginsFiltered(HttpServletRequest request, String scanWebID) throws Exception {
        ...
        for (Plugin pluginDeScanWeb : plugins) {
            ...
            scanWebPlugin = ScanWebPluginManager.getInstanceByPluginID(pluginDeScanWeb.getPluginID());
    ...
    public String scanDocument(HttpServletRequest request, String absolutePluginRequestPath,
        ...
        urlToPluginWebPage = scanWebPlugin.startScanWebTransaction(absolutePluginRequestPath, relativePluginRequestPath,
                request, scanWebInfoTester.getScanWebRequest());
    ...
    public void requestPlugin(HttpServletRequest request, HttpServletResponse response,
            String absoluteRequestPluginBasePath, String relativeRequestPluginBasePath, String scanWebID, String query,
        ...
        if (isPost) {
            scanWebPlugin.requestPOST(absoluteRequestPluginBasePath, relativeRequestPluginBasePath, scanWebID, query,
                    request, response);
        } else {
            scanWebPlugin.requestGET(absoluteRequestPluginBasePath, relativeRequestPluginBasePath, scanWebID, query,
                    request, response);
        }
    ...
    private void closeScanWebProcess(HttpServletRequest request, String scanWebID, ScanWebInfoTester pss) {
