 ...
 *
 */
public class ScanWebRequestCustodyInfo {
    ...
    /**
     * Còpia electrònica autèntica de document en paper amb canvi de format (Llei
     * 11/2007 Art. 30.2 i 30.3).
     */
    ...
    /**
     * Document Estat Elaboració EE01 - Original EE02 - Còpia electrònica autèntica
     * amb canvi de format EE03 - Còpia electrònica autèntica de document en paper
     * EE04 - Còpia electrònica parcial autèntica EE99 - Altres
     * 
    ...
    /**
     * /** Document Tipus: TD01 - Resolució,TD02 - Acord,TD03 - Contracte,TD04 -
     * Conveni, TD05 - Declaració,TD06 - Comunicació,TD07 - Notificació,TD08 -
     * Publicació, TD09 - Justificant recepció,TD10 - Acta,TD11 - Certificat,TD12 -
     * Diligència, TD13 - Informe,TD14 - Sol·licitud,TD15 - Denúncia, TD16 -
     * Al·legació,TD17 - Recurs,TD18 - Comunicació ciutadà,TD19 - Factura, TD20 -
     * Altres incautats,TD99 - Altres,
     *
     ...
     * @see ScanWebSimpleArxiuRequiredParameters.DOCUMENTORIGEN_ADMINISTRACIO
     *      Origen: 1 =>Administració 0 =>Ciutadà
     */
    protected Integer documentOrigen = null;

    /**
     * Llista de NIFs (AdministrationIDs) deles persones relacionaes/interesades en
     * aquest document
     */
    protected List<String> interestedPersons; // "12345678X,87654321Z"

    /**
     * Codi DIR3 dels organs afectats si són administracions públiques o CIF si són
     * empreses externes
     */
     ...
     * Opcional.
     */
    protected String documentarySerie; // Serie Documental = "S0001"

    /**
     * Opcional. Custòdia o expedient ja existent. Si val null llavors en crearà un
     * de nou
     */
    protected String custodyIDOrExpedientID;

    public ScanWebRequestCustodyInfo() {
        super();
    }

    public ScanWebRequestCustodyInfo(String citizenAdministrationID, String citizenFullName,
            String documentElaborationState, String documentType, Integer documentOrigen,
            List<String> interestedPersons, List<String> affectedOrganisms, String procedureName, String procedureCode,
